...
class TrainDataset(Dataset):
    def __init__(self, root_dir, num_points=1024, test_specimen_idx=9, sample_ratio = 0.2, transforms=None):
        """
    ...
    def __getitem__(self, idx):
        ...
        num_class_1 = min(int(self.num_points * sample_ratio), len(class_1))
