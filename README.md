...
Point Transformer v3 adapted for vertebrae segmentation on 3D point cloud data
For more infromation, please refer to (https://github.com/Pointcept/PointTransformerV3), the code will be updated in Pointcept v1.5. 
