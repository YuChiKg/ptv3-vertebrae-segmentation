...
def parse_args():
    ...
    parser.add_argument('--num_class', type=int, default=6, help='number of classes [0 , 1, 2, 3, 4, 5]')
    ...
    parser.add_argument('--epoch', default=45, type=int, help='Epoch to run [default: 45]')
...
def main(args):
    ...
    adjust_strength_str = args.adjust_strength
    ...
    TRAIN_DATASET = TrainDataset(root_dir=root, num_points=NUM_POINT, test_specimen_idx=args.test_specimen_idx, sample_ratio=args.sample_ratio, transforms=train_transforms)
